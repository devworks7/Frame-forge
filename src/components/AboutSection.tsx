      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="space-y-8 text-center lg:text-left flex flex-col items-center lg:items-start max-w-2xl mx-auto lg:mx-0">
            <span className="font-mono font-medium text-[12px] tracking-[0.2em] text-white/50 uppercase block">
              ABOUT THE STUDIO
            </span>
            <h2 className="font-display font-medium text-[42px] md:text-[56px] text-white leading-[1.05] tracking-tight">
          ...
          <div className="space-y-12 text-center lg:text-left flex flex-col items-center lg:items-start max-w-xl mx-auto lg:mx-0">
            <p className="font-serif italic text-[28px] sm:text-[36px] text-white/90 leading-[1.2] tracking-wide">
