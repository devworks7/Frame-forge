...
# Add to union type if not already
...
# Add Tab link
if 'Bespoke Packages' not in text:
    tabs = '''
              <button
...
'''
    text = text.replace('''              >
          ...
          <div className="p-3 rounded-xl bg-white/[0.01] border border-white/5 font-mono text-[8px] text-white/50 leading-normal space-y-1">''', tabs)

# Add Tab Content
if 'admin-tab-packages' not in text:
    package_tab = '''
